...
/usr/bin/curl -O https://s3.amazonaws.com/pe-builds/released/2018.1.0/puppet-enterprise-2018.1.0-el-7-x86_64.tar.gz

echo "Extracting Puppet Enterprise..."
/usr/bin/tar -xvf puppet-enterprise-2018.1.0-el-7-x86_64.tar.gz

echo "Installing Puppet Enterprise..."
./puppet-enterprise-2018.1.0-el-7-x86_64/puppet-enterprise-installer -c demo-pe.conf
